            ...
            <div className="shadow p-3 mb-5 bg-white rounded" id="card-shadow">
                    ...
                    <div class="card-header">
                            ...
                            <div className="card-body">
                                ...
                                <table>
                                    <div className="row">
                                        <div className="col-6"><button type="submit" className="btn btn-primary btn-block">Submit</button></div>
                                        <div className="col-6">
                                            <Link to="/"><button type="submit" className="btn btn-primary btn-block">LogOut</button>
                                            </Link>
                                        </div>
                                    </div>    
                                </table>        
